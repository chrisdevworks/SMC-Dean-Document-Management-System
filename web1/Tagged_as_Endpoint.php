...
<div class="col-lg-12">
    ...
    <a role="button" href="./index.php?page=new_document&trackingnumber=<?php echo date("Y") ?>-<?php echo date("md") ?>-<?php echo $numrand ?>-<?php echo $numrand2 ?>" class="text-white btn bg-gradient-gray mr-3 my-3 shadow-sm btn-sm">
        <i class="fas fa-sharp fa-solid fa-plus fa-sm"></i> Add a document
    </a><br>
    <b class="text-muted">List of documents tagged from your office endpoint.</b><br>

    <div class="card card-outline card-gray" style="overflow:auto; white-space: nowrap">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-hover w-auto small" id="list">
                    <thead>
                        <tr class="table-gray bg-gradient-gray text-white">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $qry = connectdb()->query("SELECT * FROM documents WHERE current_office_id = '{$userOfficeID}' AND recipient_office_id = '{$userOfficeID}' AND doc_status = 'Tagged as Endpoint' ");
                        while ($row = $qry->fetch_assoc()) :
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="./index.php?page=document_details&trackingnumber=<?php echo $row['tracking_number'] ?>&id=<?php echo $row['document_id'] ?>" class="btn btn-sm btn-outline-secondary bg-gradient-gray">VIEW</a>
                                    </div>
                                </td>
                            </tr>
                        <?php
