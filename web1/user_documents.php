...
<div class="col-lg-12">
    <button type="button" class="btn bg-gradient-red mr-3 my-3 shadow-sm btn-sm" data-toggle="modal" data-target="#userdocumentsModal"><i class="fa-regular fa-square-plus"></i> Add New</button>
    <div class="card card-outline card-primary" style="overflow:auto; white-space: nowrap">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-bordered table-hover w-auto text-xsmall" id="list">
                    <thead>
                        <tr class="table-red bg-gradient-red text-white">
                            <th class="text-center" style="width: 5%">#</th>
                            <th style="width: 10%">Tracking Number</th>
                            <th style="width: 20%">Title</th>
                            <th style="width: 20%">Originating Office</th>
                            <th style="width: 20%">Recipient Office</th>
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $qry = connectdb()->query("SELECT * FROM documents LEFT JOIN document_type ON documents.document_type_id = document_type.document_type_id RIGHT JOIN office ON documents.originating_office_id = office.office_id WHERE user_id= '" . $_SESSION['login_id'] . "'");
                        while ($row = $qry->fetch_assoc()) :
                        ?>
                            <tr>
        ...
        <div class="modal-content">
            <form action="" id="manage_type">
                <div class="modal-header">
                    <h4 class="modal-title text-red" id="exampleModalLabel"><b>New Document Type</b></h4>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group p-2 m-0">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-red"><i class="fa-solid fa-file fa-fw"></i></span>
                                        </div>
                                ...
                                <div class="form-group p-2 m-0">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="document_classification" class="form-control form-control-red" data-toggle="tooltip" data-placement="top" data-original-title="document_classification" name="document_classification_id" required>
                ...
                <div class="modal-footer">
                    <div class="col-lg-12 text-right d-flex justify-content-center">
                        ...
                        <button class="btn bg-gradient-red mr-2">Save</button>
                    </div>
                </div>
            </form>
        </div>
