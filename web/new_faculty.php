<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <form id="manage_faculty" action="">
                <div class="row ">
                    <div class="col-lg-12">
                        <b class="text-muted">Faculty Info</b>
                                ...
                                <div class="col-lg-6">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <input type="hidden" name="fid" value="<?php echo $loginid ?>">
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-primary" data-toggle="tooltip" data-placement="top" data-original-title="Course" name="course" value="<?php echo isset($smc_id) ? $course : '' ?>" placeholder="Course" required>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp == 1) {
                    ...
                    setTimeout(function() {
                        location.replace('index.php?page=faculty')
                    }, 1500)
                }
            }
        })
